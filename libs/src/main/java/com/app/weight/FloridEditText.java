...
public class FloridEditText extends EditText implements ShadowView, RoundedCornersView, StrokeView, SizeView {
	private FloridViewHelper mFloridHelper = new FloridViewHelper(this);
	
	public FloridEditText(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridEditText(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridEditText(Context context,AttributeSet attrs,int defStyleAttr) {
		super(context,attrs,defStyleAttr);
		mFloridHelper.initLayout(attrs);
	}
	
	@SuppressLint("NewApi")
	public FloridEditText(
