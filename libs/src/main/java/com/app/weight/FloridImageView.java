...
public class FloridImageView extends ImageView implements ShadowView, RoundedCornersView, StrokeView, SizeView {
	private FloridViewHelper mFloridHelper = new FloridViewHelper(this);
	
	public FloridImageView(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridImageView(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridImageView(Context context,AttributeSet attrs,int defStyleAttr) {
		super(context,attrs,defStyleAttr);
		mFloridHelper.initLayout(attrs);
	}
	
	@SuppressLint("NewApi")
	public FloridImageView(
