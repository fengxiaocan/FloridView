...
import com.app.helper.FloridViewHelper;
...
public class FloridRadioButton extends RadioButton implements ShadowView, RoundedCornersView, StrokeView, SizeView {
	private FloridViewHelper mFloridHelper = new FloridViewHelper(this);
	
	public FloridRadioButton(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridRadioButton(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridRadioButton(Context context,AttributeSet attrs,int defStyleAttr) {
		super(context,attrs,defStyleAttr);
		mFloridHelper.initLayout(attrs);
	}
	
	@SuppressLint("NewApi")
	public FloridRadioButton(
