...
public class FloridRelativeLayout extends RelativeLayout implements ShadowLayout, RoundedCornersView, StrokeView, SizeView {
	private FloridLayoutHelper mFloridHelper = new FloridLayoutHelper(this);
	
	public FloridRelativeLayout(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridRelativeLayout(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridRelativeLayout(Context context,AttributeSet attrs,int defStyleAttr) {
		super(context,attrs,defStyleAttr);
		mFloridHelper.initLayout(attrs);
	}
	
	@SuppressLint("NewApi")
	public FloridRelativeLayout(
