...
public class FloridCheckBox extends CheckBox implements ShadowView, RoundedCornersView, StrokeView, SizeView {
	private FloridViewHelper mFloridHelper = new FloridViewHelper(this);
	
	public FloridCheckBox(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridCheckBox(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridCheckBox(Context context,AttributeSet attrs,int defStyleAttr) {
		super(context,attrs,defStyleAttr);
		mFloridHelper.initLayout(attrs);
	}
	
	@SuppressLint("NewApi")
	public FloridCheckBox(
