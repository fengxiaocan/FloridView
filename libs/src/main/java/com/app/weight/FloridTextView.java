...
public class FloridTextView extends TextView implements ShadowView, RoundedCornersView, StrokeView, SizeView {
	...
	public FloridTextView(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridTextView(Context context,AttributeSet attrs,int defStyleAttr) {
		super(context,attrs,defStyleAttr);
		mFloridHelper.initLayout(attrs);
	}
	
	@SuppressLint("NewApi")
	public FloridTextView(
