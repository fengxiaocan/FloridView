...
public class FloridCoordinatorLayout extends CoordinatorLayout implements ShadowLayout, RoundedCornersView, StrokeView, SizeView {
	private FloridLayoutHelper mFloridHelper = new FloridLayoutHelper(this);
	
	public FloridCoordinatorLayout(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridCoordinatorLayout(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridCoordinatorLayout(Context context,AttributeSet attrs,int defStyleAttr) {
