...
public class FloridButton extends Button implements ShadowView, RoundedCornersView, StrokeView, SizeView {
	private FloridViewHelper mFloridHelper = new FloridViewHelper(this);
	
	public FloridButton(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridButton(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridButton(Context context,AttributeSet attrs,int defStyleAttr) {
