...
public class FloridView extends View implements ShadowView, RoundedCornersView, StrokeView, SizeView {
	private FloridViewHelper mFloridHelper = new FloridViewHelper(this);
	
	public FloridView(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridView(Context context,AttributeSet attrs) {
		super(context,attrs);
		mFloridHelper.initLayout(attrs);
	}
	
	public FloridView(Context context,AttributeSet attrs,int defStyleAttr) {
