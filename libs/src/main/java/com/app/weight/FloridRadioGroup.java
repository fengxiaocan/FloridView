...
public class FloridRadioGroup extends RadioGroup implements ShadowLayout, RoundedCornersView, StrokeView, SizeView {
	private FloridLayoutHelper mFloridHelper = new FloridLayoutHelper(this);
	
	public FloridRadioGroup(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridRadioGroup(Context context,AttributeSet attrs) {
		super(context,attrs);
