...
public class FloridViewPager extends ViewPager implements ShadowLayout, RoundedCornersView, StrokeView, SizeView {
	private FloridLayoutHelper mFloridHelper = new FloridLayoutHelper(this);
	
	public FloridViewPager(Context context) {
		super(context);
		mFloridHelper.initLayout(null);
	}
	
	public FloridViewPager(Context context,AttributeSet attrs) {
		super(context,attrs);
